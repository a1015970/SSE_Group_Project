...
// a utility class so that all crypto routines are in a single place
public class CryptoEngine {
	...
	// a unit test to check that we can encrypt and then decrypt a message
